...
public class TimeMetricsGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "esfinge.cnext.metric.TimeMetricsGenerator"; 
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TimeMetricsGenerator_ESTest_scaffolding.class.getClassLoader()); 
