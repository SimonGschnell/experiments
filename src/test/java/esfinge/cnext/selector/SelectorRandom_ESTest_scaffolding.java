...
public class SelectorRandom_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "esfinge.cnext.selector.SelectorRandom"; 
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SelectorRandom_ESTest_scaffolding.class.getClassLoader()); 
