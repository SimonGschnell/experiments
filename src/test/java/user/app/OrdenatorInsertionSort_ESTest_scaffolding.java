...
public class OrdenatorInsertionSort_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "user.app.OrdenatorInsertionSort"; 
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OrdenatorInsertionSort_ESTest_scaffolding.class.getClassLoader()); 
